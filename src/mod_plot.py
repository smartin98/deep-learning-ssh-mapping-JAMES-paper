...
#     fig = plt.figure(1,1 figsize = (10,10), tight_layout = True)
#     ax.cla()
#     for ds in list_of_dataset_sel:
#         plt..scatter(ds.longitude % 360., ds.latitude, c=ds.sla_unfiltered, s=20, cmap='gist_stern', animated = True)
#     ax.add_patch(Rectangle((295, 33), 10, 10, fill=None, alpha=1))
#     ax.set_xlabel('longitude', fontweight='bold')
#     ax.set_ylabel('latitude', fontweight='bold')
#     ax.set_title(f'SLA @ altimeter track ' + str(central_date))
#     ax.add_colorbar(orientation='horizontal')
#     ax.add_text(298, 43.5,'STUDY AREA')
#     return fig
    
    plot_dir = '/dat1/smart1n/aviso-data/2021a_SSH_mapping_OSE/plots/'
    ...
    for ds in list_of_dataset_sel:
        ...
        plt.title('SLA @ altimeter track'+str(central_date))
        plt.clim(-1,1)
        plt.colorbar(orientation='horizontal')
        plt.text(298, 43.5,'STUDY AREA')
        plt.savefig(fname = plot_dir+str(central_date)+'.png', facecolor = 'w')
        plt.show()
    
def plot_demo_obs2(list_of_dataset, central_date, delta_t):
    tmin = central_date #- delta_t
    tmax = central_date + delta_t
...
#     return fig
    ...
    plt.subplot(111)
    for ds in list_of_dataset_sel:
        plt.scatter(ds.longitude % 360., ds.latitude, marker = 'x', s = 1)
        ax = plt.gca()
        ax.add_patch(Rectangle((295, 33), 10, 10, fill=None, alpha=1))
        plt.xlabel('longitude', fontweight='bold')
        plt.ylabel('latitude', fontweight='bold')
